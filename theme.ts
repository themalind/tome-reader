...
export type AppTheme = MD3Theme & Theme;
...
//satisfies Partial<AppTheme>) as AppTheme;
// Säkerhetsställer att objektet följer AppTheme. Samma som att typa tex "book :Book"
// Partial - Gör properties undefinable alltså inte obligatoriska.
